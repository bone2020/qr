...
DocumentReference? get currentUserReference =>
    loggedIn ? BiometricDataRecord.collection.doc(currentUser!.uid) : null;

BiometricDataRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BiometricDataRecord.getDocument(
                  BiometricDataRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
